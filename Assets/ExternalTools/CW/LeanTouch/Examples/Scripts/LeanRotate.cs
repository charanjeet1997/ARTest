...
namespace Lean.Touch
{
	...
	{
		[Tooltip("Ignore fingers Hover?")]
		public bool IgnoreHoverFingers;
		...
		protected virtual void Update()
		{
			...
			var fingers = LeanTouch.GetFingers(IgnoreGuiFingers, IgnoreGuiFingers,RequiredFingerCount,IgnoreHoverFingers);
